...
const describeFunctionsTable = async () => {
  console.log("--- Début du script de description de la table 'functions' ---");
  ...
  try {
    ...
    console.log("🔧 Description de la table 'functions'...");
    const tableInfo = await conn.query(`DESCRIBE functions;`);
    console.log("✅ Informations sur la table 'functions':");
